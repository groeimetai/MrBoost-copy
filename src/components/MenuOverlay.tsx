              ...
              >
                ...
                >
                  <motion.a
                    ...
                    whileHover="hover"
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 border border-creme flex items-center justify-center text-sm font-bold relative overflow-hidden cursor-pointer"
                  >
                    <motion.span
                  ...
                  <motion.a
                    ...
                    whileHover="hover"
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 border-t border-b border-r border-creme flex items-center justify-center relative overflow-hidden cursor-pointer"
                  >
                    <motion.svg
